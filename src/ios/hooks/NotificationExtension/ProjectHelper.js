...
ProjectHelper.PODFILE_SNIPPET = "target 'NetmeraPushNotificationServiceExtension' do\n" +
  "  platform :ios, '11.0'\n" +
  "  use_frameworks!\n" +
  "  pod 'Netmera', '" + ProjectHelper.POD_VERSION + "'\n" +
  "end\n";
ProjectHelper.NOTIFICATION_SERVICE_EXTENSION_NAME = 'NetmeraPushNotificationServiceExtension';
