  ...
  return fs.copy(source, destination)
    ...
    .then(() => {
      ...
      const filePaths = [
        ...
        'netmerapushnotificationserviceextension-debug.xcconfig',
        'netmerapushnotificationserviceextension-release.xcconfig',
      ];
      ...
      for (const buildConfiguration of buildConfigurations) {
        ...
        const baseConfigurationFileReference = projectHelper.findFileByName(`netmerapushnotificationserviceextension-${environment.toLowerCase()}.xcconfig`);
